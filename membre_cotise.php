...
if(isset($_POST['submit']))
{
    ...
    if(!empty($_POST['montantcot'])  AND !empty($_POST['montantver']) AND !empty($_FILES['image']))
    {   
        
        $montantcot = $_POST['montantcot'];
        // $nom = htmlspecialchars($_POST['Nom']);
        // $prenom = htmlspecialchars($_POST['Prenom']);
        $montantver = $_POST['montantver'];
        ...
        // $password_retype = $_SESSION['form_data']['confirmPassword'];
                            ...
                            $enreg1 = $bdd->prepare("INSERT INTO versementcotis(montant_Ver,photoCotis,deux_vers,photorecus) VALUES(:montant_Ver,:photoCotis,:deux_vers,:photorecus)");
                            $enreg1->execute(array(
                                'montant_Ver' => $montantcot,
                                'photoCotis' => '4kjksdn',
                                'deux_vers' => $montantver,
                                'photorecus' => 'kdnfdnd'
                                ...
                                header('Location: membre_cotise.php?reg_err=success');
                        
                      
                        }      
      else
      {
          header('Location: membre_cotise.php?reg_err=remplir'); 
      }
}
...
<body>
    ...
    <div class="container-fluid">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                ...
                <nav id="navbar" class="nav-menu navbar">
                    <ul class="w-100 lol">
                        ...
                        <hr>
                        <li><a href="./membre_cotise.php" class="nav-link scrollto text-light act"><span>Cotiser</span></a></li>
                        <hr>
                    ...
                    switch($err)
                    {
                        ...
                        ?>
                            <div class="alert alert-success">
                                <strong>Succès</strong> Depot enregistré en attente de la confirmation du tresorier!
                            </div>
                        <?php
                        break;
        ...
        <form class="for1" action="" method="post" enctype="multipart/form-data">
          ...
          <div class="col-lg-10">
            <label for="" class="col-sm-6">Montant de la cotisation versé</label>
            <input rows="5"  type="text" class="col-sx-10" id="montantcot" value="<?php //echo "$nom";?>"  name = "montantcot" placeholder=""><br> <br>
          </div>
          <div class="col-lg-10">
            <label for="" class="col-sm-6">Montant de l'epargne</label>
            <input type="text" class="col-sx-10" id="montantver" value="<?php //echo "$prenom";?>" name="montantver" placeholder=""><br> <br>
          </div>
          
          <div class="col-lg-10">
            <label for="" class="col-sm-6">photo de l'envoi</label>
