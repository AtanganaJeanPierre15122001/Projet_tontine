    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
        ...
        <nav id="navbar" class="nav-menu navbar">
          <ul class="w-100 lol">
            ...
            <hr> -->
            <li><a href="./tresorier_cotisation.php" class="nav-link scrollto text-light"><span> GERER <br> COTISATION </span></a></li>
            <hr>
            <li><a href="./tresorier_pret.php" class="nav-link scrollto text-light"><span> GERER <br> PRET </span></a></li>
            <hr>
            <li><a href="#" class="nav-link scrollto text-light"><span> GERER <br> AIDE </span></a></li>
          </ul>
        </nav><!-- .nav-menu -->
