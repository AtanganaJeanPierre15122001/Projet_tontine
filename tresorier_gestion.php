...
$idR=$_SESSION['idR'];
$insert1 = $bdd->prepare("SELECT * FROM membre where Id_reunion = $idR");
$insert1->execute();
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                ...
                <nav id="navbar" class="nav-menu navbar">
                    <ul class="w-100 lol">
                        ...
                        <li><a href="./tresorier_caisse.php" class="nav-link scrollto text-light"><span>Consulter l'etat des <br> caisses</span></a></li>
                        <hr>
                        <li><a href="#" class="nav-link scrollto text-light act"><span>consulter la liste des <br> membres</span></a></li>
                        <hr>
